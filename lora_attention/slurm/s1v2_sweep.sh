#!/bin/bash
#
# Stage-1 v2.0: Focused inference sweep
#
# Key questions answered:
#   Q1. Does ref B-LoRA injection produce visible style change?    (SWEEP 3)
#   Q2. Does synth at norm_match=True produce visible style change? (SWEEP 1)
#   Q3. Does neutral prompt ("A painting") expose styling better?  (SWEEP 4)
#   Q4. Does temp / top_k affect result after norm-matching?       (SWEEP 1)
#
# ~60 runs × 1 image each ≈ 2-3h on V100.
#
# Usage:
#   cd /home/eyavuz21/repos/MoLoRAs
#   sbatch lora_attention/slurm/s1v2_sweep.sh
#

#SBATCH --job-name=S1v2-Sweep
#SBATCH --nodes=1
...
CKPT="/scratch/eyavuz21/lora_attention/stage1_v2/latest.pt"
OUT_ROOT="/scratch/eyavuz21/lora_attention/s1v2_sweep"
