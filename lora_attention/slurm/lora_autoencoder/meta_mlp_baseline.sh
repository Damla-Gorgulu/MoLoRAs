#!/bin/bash
#SBATCH --job-name=LoRA-AE-MetaMLP
#SBATCH --partition=ai
#SBATCH --account=ai
#SBATCH --qos=ai
...
#SBATCH --output=/home/eyavuz21/logs/lora-ae-metamlp-%j.out
#SBATCH --error=/home/eyavuz21/logs/lora-ae-metamlp-%j.err
...
python diagnostics/meta_mlp_baseline.py \
  --zoo_dir /home/eyavuz21/repos/B-LoRA/blora_zoo/bloras \
  --limit 1 --idx 0 \
  --output_dir /scratch/eyavuz21/lora_autoencoder/meta_mlp_baseline \
