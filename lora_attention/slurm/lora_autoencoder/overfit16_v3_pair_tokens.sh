#!/bin/bash
#SBATCH --job-name=LoRA-AE-Overfit16-v3
#SBATCH --partition=ai
#SBATCH --account=ai
#SBATCH --qos=ai
...
#SBATCH --output=/home/eyavuz21/logs/lora-ae-overfit16-v3-%j.out
#SBATCH --error=/home/eyavuz21/logs/lora-ae-overfit16-v3-%j.err
...
python train_lora_autoencoder.py \
  ...
  --output_dir /scratch/eyavuz21/lora_autoencoder/overfit16_v3_pair_tokens \
  --limit 16 \
  --latent_dim 40960 \
  --d_model 512 \
  --num_layers 4 \
  ...
  --wandb_run_name overfit16_v3_pair_tokens
