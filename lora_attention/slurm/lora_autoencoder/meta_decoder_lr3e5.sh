#!/bin/bash
#SBATCH --job-name=LoRA-AE-MetaDec-lr5
#SBATCH --partition=ai
#SBATCH --account=ai
#SBATCH --qos=ai
...
#SBATCH --output=/home/eyavuz21/logs/lora-ae-metadec-lr5-%j.out
#SBATCH --error=/home/eyavuz21/logs/lora-ae-metadec-lr5-%j.err
...
python diagnostics/meta_decoder_baseline.py \
  ...
  --limit 1 --idx 0 \
  --output_dir /scratch/eyavuz21/lora_autoencoder/meta_decoder_lr3e5 \
  --max_steps 5000 --lr 3e-5 --clip 0.1 --log_every 10 --device cuda
